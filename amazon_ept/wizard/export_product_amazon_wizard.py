...
class ExportAmazonProductWizard(models.TransientModel):
    ...
    def export_product_in_amazon(self):
        ...
        for instance in amazon_product_instance:
            amazon_products = amazon_product.filtered( \
                lambda
                    l: l.instance_id.id == instance.id and l.fulfillment_by == 'FBM' and l.exported_to_amazon)
    ...
    def update_stock_ept(self):
        ...
        for instance in amazon_product_instance:
            amazon_products = amazon_product.filtered(\
                lambda l: l.instance_id.id == instance.id and l.fulfillment_by == 'FBM' and l.exported_to_amazon)
            if amazon_products:
