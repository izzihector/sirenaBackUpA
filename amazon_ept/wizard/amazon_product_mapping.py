...
class AmazonProductMapping(models.TransientModel):
    ...
    instance_ids = fields.Many2many("amazon.instance.ept", string="Instance")
    ...
    def prepare_product_value_for_export(self, prdouct):
        """
