...
class AmazonProductEpt(models.Model):
    ...
    def prepare_export_stock_level_dict_operation(self, amazon_product, instance, actual_stock,
        ...
        fullfillment_latency = amazon_product['fulfillment_latency'] or \
                               instance.seller_id.fulfillment_latency
        message_information += """<Message><MessageID>%s</MessageID><OperationType>Update
        </OperationType> <Inventory><SKU>%s</SKU><Quantity>%s</Quantity><FulfillmentLatency>%s
        </FulfillmentLatency> </Inventory></Message>""" % (message_id, seller_sku, stock,
    ...
    def create_image_dict(self, amazon_product, image_obj, message_information, message_id):
        ...
        </ImageLocation></ProductImage></Message>""" % ( \
    ...
    def name_get(self):
        ...
        if self._context.get('show_product_title', False):
            ...
            return res
        return super(AmazonProductEpt, self).name_get()
